...
**Tests**: The examples below include test tasks. Tests are REQUIRED by the
constitution and must be included for each user story at the appropriate levels.
...
- [ ] T004 [P] Configure static analysis/type-checking tools
- [ ] T005 Define baseline performance budget checks for the feature
- [ ] T006 Define shared UX consistency checklist (states, accessibility, copy)
...
- [ ] T014 [P] [US1] Contract or e2e test for [endpoint/journey] in tests/contract/test_[name].py
...
- [ ] T021 [US1] Add logging/metrics for user story 1 operations
- [ ] T022 [US1] Validate UX consistency states and accessibility acceptance criteria
- [ ] T023 [US1] Validate performance budgets for user story 1
...
- [ ] T025 [P] [US2] Contract or e2e test for [endpoint/journey] in tests/contract/test_[name].py
...
- [ ] T031 [US2] Validate UX consistency states and accessibility acceptance criteria
- [ ] T032 [US2] Validate performance budgets for user story 2
...
- [ ] T034 [P] [US3] Contract or e2e test for [endpoint/journey] in tests/contract/test_[name].py
...
- [ ] T039 [US3] Validate UX consistency states and accessibility acceptance criteria
- [ ] T040 [US3] Validate performance budgets for user story 3
...
- [ ] TXXX [P] Cross-story UX consistency and accessibility audit
